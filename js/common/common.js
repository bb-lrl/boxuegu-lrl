...
// 左侧导航下拉列表
     ...
     * */
    // var pathname=window.locatioin.pathname;
...
// 然后展示到左侧导航//模板引擎
    $('.aside .profile h4').html(userInfo.tc_name? userInfo.tc_name:'dageimeiminga');
    $('.aside .profile img').attr('src',userInfo.tc_avatar? userInfo.tc_avatar:'/img/b.jpeg');
});
